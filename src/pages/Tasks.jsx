...
const Tasks = () => {
  ...
  const myTask = tasks.filter((task) => task.assignedTo === name);
  // console.log(myTask.length);
  const pendingTask = tasks.filter((task) => task.status === "pending");
  const onGoingTask = tasks.filter((task) => task.status === "on-going");
  ...
  return (
    <div className=" grid grid-cols-12">
      ...
      <div className="col-span-3 border-l-2 border-secondary/20 px-10 pt-10">
        ...
        <div className="space-y-3 h-[700px] overflow-auto">
